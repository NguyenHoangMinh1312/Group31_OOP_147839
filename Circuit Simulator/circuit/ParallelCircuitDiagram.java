...
public class ParallelCircuitDiagram extends JPanel{
    ...
    protected void paintComponent(Graphics g){
        ...
        for(ElectricComponent i : this.circuit.getElements() ){
            g2d.drawLine(x, y, x + 70, y);
            g2d.drawLine(x, 200, x+70, 200);
            x+=70;
            ...
            if(i instanceof Resistor){
                ...
                g2d.drawString(i.getName(), x-25, y+50);
            }
                ...
                g2d.drawString(i.getName(), x-35, y+55);
                ...
                g2d.drawString(i.getName(), x-20, y + 50);
